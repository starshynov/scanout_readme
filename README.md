...
### Brief description
ScanOut — модульная система визуализации, хранения и анализа гео- и контент-данных.  
Система объединяет мобильный и веб-клиент для администрирования, мониторинга и обмена данными между пользователями с разными уровнями доступа.

### Project goal
Создать универсальную платформу для сбора, визуализации и обмена данными, которая будет масштабироваться от MVP до коммерческой версии с микросервисной архитектурой.

### Product history
Первоначально ScanOut разрабатывался как инструмент для визуализации координат на карте (Leaflet + PostGIS).  
В дальнейшем был расширен до комплексной системы с модулями: Auth, Geo, Reader, Notifications и другими.
